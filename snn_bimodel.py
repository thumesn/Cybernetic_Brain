...
optimizer_red = optim.Adam(model_red.parameters(), lr=0.0001)
optimizer_green = optim.Adam(model_green.parameters(), lr=0.0001)
...
for epoch in range(num_epochs):
    ...
    if accuracy > best_acc:
        best_acc = accuracy
        torch.save(model_red.state_dict(), "./save/snn/mymodel_snn_red.pt")
        torch.save(model_green.state_dict(), "./save/snn/mymodel_snn_green.pt")
